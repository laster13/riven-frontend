...
<div class="mt-32 p-8 md:px-24 lg:px-32">
	<div class="flex flex-col gap-8 lg:flex-row">
		<img
			...
			loading="lazy"
			class="aspect-[1/1.5] max-h-96 rounded-lg object-cover object-center transition-all duration-300 ease-in-out group-hover:scale-105"
		/>
		<div>
	...
	{#if data.details.combined_credits && data.details.combined_credits.cast.length > 0}
	...
	{#if data.details.combined_credits && data.details.combined_credits.crew.length > 0}
